# OSMM — Contributor Benefits

OSMM is built to be a **collaborative project that benefits the whole makerspace community**. When
you contribute, you sign the [Contributor License Agreement](CLA.md) — which lets OSMM-HQ keep the
exclusive right to sell commercial licenses — and in return you receive the benefits below.

Benefits **scale with the significance of your contribution.** OSMM-HQ decides which tier a
contribution falls into, in good faith.
...
- a **share of commercial revenue** attributable to your work, or
- another form of recognition or reward agreed in writing.
...
- **Commercial rights are not granted to contributors.** Contributing does not give you the right to
  ...
  [PERMISSIONS.md](../PERMISSIONS.md) (which, separately, already let any makerspace —
...
- The right to **commercialize** OSMM is reserved exclusively to OSMM-HQ (see
  [COMMERCIAL.md](../COMMERCIAL.md)). Contributors are rewarded through the benefits
